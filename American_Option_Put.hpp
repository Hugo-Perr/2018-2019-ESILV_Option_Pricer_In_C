...
#ifndef American_Option_Put_hpp
#define American_Option_Put_hpp
...
class American_Option_Put : public Option
{
private:
...
public:
    // CONSTRUCTOR
    American_Option_Put(double r_,double sigma_,double K_,double T_,double S0_,double b_, int n_) : Option(r_,sigma_,K_,T_,S0_,b_,n_)
    {
